Feature: SellerProfile
		...
		@mytag
Scenario: As a Seller I want to add my Profile
...
Scenario: As a Seller I want to add my Language in my profile
...
Scenario: As a Seller I want to add my Education details in my profile
